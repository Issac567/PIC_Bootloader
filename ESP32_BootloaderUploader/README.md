...
2.  SD Card requires `flash.bin` and `config.map` exported by [B4J Uploader](https://github.com/ElectronicFan/PIC_Bootloader/tree/main/B4J_BootloaderUploader).  In `B4J`, select **PIC Name** from list, click **Tools->Export for ESP32**.
