...
![Image](./Help/scan.jpg)
**Connect BLE**
![Image](./Help/connectble.jpg)
**Select PIC**
![Image](./Help/selectpic.jpg)
**Config Data**
![Image](./Help/config.jpg)
**Load Firmware**
![Image](./Help/loadfirmware.jpg)
**Flash Firmware**
![Image](./Help/flash.jpg)
**Verify Firmware**
![Image](./Help/verify.jpg)
**Flash Success!**
![Image](./Help/successflash.jpg)
...
* [4. DT-06 Custom](#hm-10-bluetooth-ble)
* [5. AT Command Mode](#dt-06-wifi-tcp/ip)
...
> ⚠️ Ensure voltage compatibility. Most `HCM-10` breakout boards accept **5V on VCC**, but logic levels are typically **3.3V**.
