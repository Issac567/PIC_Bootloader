# PIC18F27Q43 UART Bootloader Project

![PIC18F27Q43 Bootloader Diagram](18F27Q43Image.jpg)

This repository contains a **complete UART bootloader solution** for the **PIC18F27Q43**, including:
...
The goal of this project is to provide a clean, understandable reference implementation of a PIC18F27Q43 bootloader with a PC-side uploader.

---

## 📂 Repository Structure

* `/MPLAB Projects/BootLoader18F27Q43.X`      → MPLAB X Bootloader firmware  
* `/MPLAB Projects/BootloaderApp18F27Q43.X`   → MPLAB X Application firmware
* `/MPLAB Projects/Shared18F27Q43`            → Uart shared
...
### 1️⃣ BootLoader18F27Q43.X (Bootloader)
...
### 2️⃣ BootloaderApp18F27Q43.X (Application)
...
* Designed specifically for PIC18F27Q43 bootloader protocol
...
![PIC18F27Q43 Pickit Diagram](Pickit3b.png)

---

## 🔌 Pin Connections

| PIC18F27Q43 Pin | Connection                       | Notes                     |
|-----------------|---------------------------------|---------------------------|
