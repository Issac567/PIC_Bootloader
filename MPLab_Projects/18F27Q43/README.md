...
![18F27Q43 Bootloader Diagram](18F27Q43Image.jpg)
...
* `/BootLoader18F27Q43.X`      → MPLAB X Bootloader firmware  
* `/BootloaderApp18F27Q43.X`   → MPLAB X Application firmware
* `/MPLAB Projects/Shared18F27Q43` → UART and Config.h shared
