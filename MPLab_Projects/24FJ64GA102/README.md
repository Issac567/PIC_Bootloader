...
* `/MPLAB Projects/Shared24FJ64GA102` → UART and Config.h shared
...
### 1️⃣ BootLoader24FJ64GA102.X (Bootloader)
...
### 2️⃣ BootloaderApp24FJ64GA102.X (Application)
...
* Designed specifically for PIC24FJ64GA102 bootloader protocol
* Load Firmware `BootloaderApp24FJ64GA102.X.production.hex` under `dist/default/production/`
...
| PIC24FJ64GA102 Pin | Connection                      | Notes                    |
|-------------|---------------------------------|--------------------------|
...
Enjoy hacking the PIC24FJ64GA102 🚀
